...
def train_sr(train_path, epoch_num=5):
...
def main():
    train_path = '../../../nlptutorial/data/mstparser-en-train.dep'
    test_path = '../../../nlptutorial/data/mstparser-en-test.dep'
    out_path = 'out.txt'
    train_sr(train_path, 1)
